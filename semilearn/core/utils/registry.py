...
ALL_MODULES = [
    ...
    ('semilearn.algorithms', ['fixmatch', 'fullysupervised','decouple','cost_sensitive','mixmatch','ldam','ldam_cs']),
    ('semilearn.imb_algorithms', ['abc', 'cossl', 'adsh', 'crest', 'darp', 'daso',
                                  'abc_iac','adsh_iac','cossl_iac','crest_iac','darp_iac','daso_iac','iac'])
]
