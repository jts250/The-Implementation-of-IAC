...
class VisionTransformer(nn.Module):
    ...
    def __init__(
        ...
        self.classifier = nn.Linear(self.embed_dim, num_classes) if num_classes > 0 else nn.Identity()#self.head
