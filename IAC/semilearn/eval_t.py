...
def main_worker(gpu, ngpus_per_node, args):
    ...
    eval_loader = get_data_loader(args,
                                  model.dataset_dict['train_lb'],#eval.'train_ulb'
                                  100,#args.batch_size,
    ...
    with torch.no_grad():
        ...
        for data in eval_loader:
            ...
            #无标签数据
            #image = data['x_ulb_w']
            #target = model.dataset_dict['train_ulb'].targets[data['idx_ulb']]
    ...
    np.save('features_raw_train.npy', saved_features.detach().cpu().numpy())
    np.save('results_raw_train.npy', saved_ids.detach().cpu().numpy())
